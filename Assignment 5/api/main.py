...
@app.post("/orderDetails/", response_model=schemas.OrderDetail, tags=["Order Details"])
...
@app.get("/orderDetails/", response_model=list[schemas.OrderDetail], tags=["Order Details"])
def read_orderDetails(db: Session = Depends(get_db)):
    return order_details.read_all(db)


@app.get("/orderDetails/{orderDetail_id}", response_model=schemas.OrderDetail, tags=["Order Details"])
...
@app.put("/orderDetails/{orderDetail_id}", response_model=schemas.OrderDetail, tags=["Order Details"])
